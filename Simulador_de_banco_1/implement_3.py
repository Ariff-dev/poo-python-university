...
def getsaldo(numero_de_cuenta, contrasenia):
  ...
  if numero_de_cuenta == 0:
    ...
    #*Si el //parametro// = contrasenia es igual a la contrasenia de la cuenta_1
      ...
      return f"Tu saldo es: {saldo_cuenta_0}"
  ...
  if numero_de_cuenta == 1:
      ...
      return f"Tu saldo es: {saldo_cuenta_1}"
...
def deposito (numero_de_cuenta, deposito, contrasenia):
   ...
   if( numero_de_cuenta == 0):
    ...
    #*Crear el nuevo saldo usando el saldo de la cuenta_1 + el deposito 
      ...
      saldo_cuenta_0 = nuevo_saldo
      return f"Tu saldo actual es: ${saldo_cuenta_0}"
...
while True:
  ...
  print('Presiona a para hacer obtener saldo') #f: getsaldo()
  ...
  def switchAction (action):
     if action == "b":
        ...
        numero_de_cuenta = int(input("¿En que cuenta quieres hacer el deposito?"))
        ...
        if( numero_de_cuenta == 0):
           ...
           if( contrasenia != contrasenia_cuenta_0):
              print(contrasenia_cuenta_0)
              return f"Contraseña Incorrecta: {contrasenia_cuenta_0}"
           
           return deposito(numero_de_cuenta, input_deposito, contrasenia)
        ...
        if( numero_de_cuenta == 1):
           ...
           return "Selecciona una cuenta existente"
            ...
            numero_de_cuenta = int(input("¿En que cuenta quieres hacer el retiro?"))
            ...
            if( numero_de_cuenta == 0):
                ...
                return retiro(numero_de_cuenta, input_retirar, contrasenia)
            ...
            numero_de_cuenta = int(input("¿En que cuenta quieres mostrar el saldo?"))

            if( numero_de_cuenta == 0):
               contrasenia = input("Escribe la contraseña de la cuenta: ")
               if( contrasenia != contrasenia_cuenta_0):
                    return "Contraseña Incorrecta"
               return getsaldo(numero_de_cuenta, contrasenia)
